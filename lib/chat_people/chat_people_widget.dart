...
class ChatPeopleWidget extends StatefulWidget {
  const ChatPeopleWidget({Key key}) : super(key: key);

  @override
  _ChatPeopleWidgetState createState() => _ChatPeopleWidgetState();
}

class _ChatPeopleWidgetState extends State<ChatPeopleWidget> {
