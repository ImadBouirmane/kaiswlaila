...
class NavbarSettingsWidget extends StatefulWidget {
  const NavbarSettingsWidget({Key key}) : super(key: key);

  @override
  _NavbarSettingsWidgetState createState() => _NavbarSettingsWidgetState();
}
            ...
            Material(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    'assets/images/icons8_settings_30px.png',
                  ),
                ),
              ),
            ),
