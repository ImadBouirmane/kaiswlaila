...
Stream<List<MatchesRecord>> queryMatchesRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(MatchesRecord.collection, MatchesRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<MatchesRecord>> queryMatchesRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(MatchesRecord.collection, MatchesRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Stream<List<InterestsRecord>> queryInterestsRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(InterestsRecord.collection, InterestsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<InterestsRecord>> queryInterestsRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(InterestsRecord.collection, InterestsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
