...
class _$NotificationsRecord extends NotificationsRecord {
  ...
  _$NotificationsRecord._({this.title, this.reference}) : super._();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, title.hashCode), reference.hashCode));
  }
...
class NotificationsRecordBuilder
  ...
  _$NotificationsRecord build() {
    final _$result =
        _$v ?? new _$NotificationsRecord._(title: title, reference: reference);
    replace(_$result);
    return _$result;
  }
}
