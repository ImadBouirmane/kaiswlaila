...
class SignupStepWidget extends StatefulWidget {
  const SignupStepWidget({Key key}) : super(key: key);

  @override
  _SignupStepWidgetState createState() => _SignupStepWidgetState();
}

class _SignupStepWidgetState extends State<SignupStepWidget> {
