...
class _QsModifyPage2WidgetState extends State<QsModifyPage2Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'QsModifyPage2'});
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final qsModifyPage2UsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'QS_MODIFY_PAGE2_chevron_left_ICN_ON_TAP');
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'QS_MODIFY_PAGE2_PAGE_step4_ON_TAP');
