...
class _QsModifyPage8WidgetState extends State<QsModifyPage8Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'QsModifyPage8'});
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final qsModifyPage8UsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          body: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'QS_MODIFY_PAGE8_chevron_left_ICN_ON_TAP');
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'QS_MODIFY_PAGE8_PAGE_step4_ON_TAP');
